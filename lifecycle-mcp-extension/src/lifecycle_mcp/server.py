...
class LifecycleMCPServer:
    ...
    def __init__(self):
        ...
        self.handlers = {
            ...
            "decompose_requirement": self.requirement_handler,
            "suggest_requirement_decomposition": self.requirement_handler,
            "validate_requirement_decomposition": self.requirement_handler,
