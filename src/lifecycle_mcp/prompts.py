...
has to do. You read it; the server does not. Work in this order and do not skip the first step.

1. Read what is already there. Call query_requirements with no filters for the whole set, or with search_text when
   the set is large. You cannot classify anything before you know what exists.
2. Find the candidates in the source: each thing it says the system must do, be, or be built from.
...
4. Report the four buckets before you write anything, so the person can see what you are about to do.
