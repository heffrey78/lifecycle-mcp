...
class TestAboveFoldFormatting:
    ...
    def test_create_above_fold_response_with_action(self, handler):
        ...
        result = handler._create_above_fold_response("SUCCESS", "Task TASK-001 created", "📋 Test Task | P1 | Medium")
    ...
    def test_create_above_fold_response_no_action_with_details(self, handler):
        ...
        result = handler._create_above_fold_response("ERROR", "Operation failed", "", "Error details here")
    ...
    def test_format_status_summary(self, handler):
        ...
        result_with_extra = handler._format_status_summary("Requirement", "REQ-001", "Draft", "needs review")
    ...
    def test_format_count_summary(self, handler):
        ...
        result_with_filter = handler._format_count_summary("requirement", 3, "status: Draft | priority: P1")
